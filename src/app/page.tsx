        ...
        <div className="mx-4 md:mx-auto md:w-3/4">
          <section className="bg-white p-6 rounded shadow">
            ...
            <p className="text-gray-700">
              ...
              características y aplicaciones específicas. Algunos de los tipos
              más comunes son:
            </p>
            <ul className="list-disc list-inside text-gray-700 mt-2">
              ...
              <li>
                ...
                cuarzo, lo que aumenta su resistencia y durabilidad. Son
                adecuadas para áreas con requerimientos de resistencia
                extremadamente altos.
              </li>
              <li>
                Resinas Transparentes: Diseñadas para crear pisos de apariencia
                transparente o semitransparente. Se utilizan a menudo en
                espacios donde se desea resaltar la apariencia del sustrato
                existente.
              </li>
            </ul>
            <p className="text-gray-700 mt-2">
              Elegir el tipo de resina epóxica adecuado depende de las
              necesidades específicas del proyecto, el entorno y el nivel de
          ...
          <section className="bg-white p-6 rounded shadow">
            ...
            <p className="text-gray-700 mt-2">
              Sin embargo, también hay algunas desventajas que deben
              considerarse:
            </p>
            <ul className="list-disc list-inside text-gray-700 mt-2">
              <li>
                <strong>Costo Inicial:</strong> La instalación de pisos de
                resina epóxica puede ser más costosa en comparación con otros
                tipos de pavimentos.
              </li>
              <li>
                <strong>Sensibilidad a la Humedad:</strong> Algunos tipos de
                resinas epóxicas pueden ser sensibles a la humedad, lo que
                podría afectar su durabilidad en ciertos entornos.
              </li>
              <li>
          ...
          <section className="bg-white p-6 rounded shadow">
            ...
            <p className="text-gray-700">
              ...
              aplicaciones debido a su durabilidad y versatilidad. Algunas de
              las aplicaciones comunes incluyen:
            </p>
            <ul className="list-disc list-inside text-gray-700 mt-2">
              <li>
                <strong>Áreas Industriales:</strong> Los pisos epóxicos son
                ideales para fábricas, almacenes y plantas de producción debido
                a su resistencia a productos químicos, impactos y tráfico
                pesado.
              </li>
              <li>
              ...
              <li>
                <strong>Garajes y Talleres:</strong> Son muy utilizados en
                garajes y talleres debido a su resistencia al aceite, grasa y
                abrasiones, además de ser fáciles de limpiar.
              </li>
              <li>
                <strong>Entornos Sanitarios:</strong> En hospitales,
                laboratorios y espacios médicos, los pisos epóxicos ofrecen una
                superficie higiénica y fácil de desinfectar.
              </li>
              <li>
                <strong>Áreas de Alimentación:</strong> En cocinas comerciales y
                restaurantes, los pisos de resina epóxica cumplen con los
                estándares de seguridad alimentaria y son resistentes a
                derrames.
              </li>
              <li>
                <strong>Instalaciones Deportivas:</strong> En gimnasios y
                canchas deportivas, estos pisos proporcionan un acabado liso y
                amortiguado que es ideal para actividades físicas.
              </li>
            </ul>
            <p className="text-gray-700 mt-2">
          ...
          <section className="bg-white p-6 rounded shadow">
            ...
            <p className="text-gray-700">
              Una de las ventajas más destacadas de los pisos de resina epóxica
              es la amplia gama de opciones de diseño y colores disponibles.
              Estas opciones permiten crear pisos únicos y personalizados que se
              adapten a la estética de cualquier espacio.
            </p>
            <p className="text-gray-700 mt-2">
            ...
            <ul className="list-disc list-inside text-gray-700 mt-2">
              <li>
                <strong>Colores Sólidos:</strong> Puedes elegir entre una
                variedad de colores sólidos para crear un fondo uniforme y
                moderno.
              </li>
              <li>
                <strong>Efectos Metálicos:</strong> Los pisos epóxicos con
                efectos metálicos añaden un aspecto brillante y sofisticado,
                similar a los reflejos del metal.
              </li>
              <li>
                <strong>Marmolados:</strong> Mediante la combinación de colores
                y técnicas de marmolado, es posible lograr un acabado similar al
                mármol.
              </li>
              <li>
          ...
          <section className="bg-white p-6 rounded shadow">
            ...
            <p className="text-gray-700">
              ...
              facilidad de mantenimiento. Aquí hay algunos consejos para
              mantener y limpiar adecuadamente estos pisos:
            </p>
            <ul className="list-disc list-inside text-gray-700 mt-2">
              <li>
                <strong>Limpieza Regular:</strong> Barre o aspira el piso
                regularmente para eliminar el polvo y la suciedad que pueden
                rayar la superficie.
              </li>
              <li>
                <strong>Limpieza Húmedad:</strong> Limpia el piso con una
                solución suave de agua tibia y un limpiador neutro. Evita el uso
                de limpiadores abrasivos.
              </li>
              <li>
                <strong>Derrames Rápidos:</strong> Limpia los derrames de
                líquidos de inmediato para evitar que se absorban y causen
                manchas.
              </li>
              <li>
              ...
              <li>
                ...
                objetos pesados, coloca almohadillas protectoras en las patas
                para evitar arañazos.
              </li>
              <li>
                <strong>Evita Sustancias Agresivas:</strong> Evita el contacto
                con productos químicos agresivos que puedan dañar la resina.
              </li>
            </ul>
            <p className="text-gray-700 mt-2">
              Siguiendo estos consejos, los pisos de resina epóxica se
              mantendrán en excelentes condiciones y su aspecto perdurará a lo
              largo del tiempo.
            </p>
          </section>
          <section className="bg-white p-6 rounded shadow">
            ...
            <ul className="list-disc list-inside text-gray-700 mt-2">
              <li>
                <strong>Madera:</strong> A diferencia de los pisos de madera,
                los epóxicos son más resistentes al agua y a los impactos, lo
                que los hace ideales para ambientes húmedos o de alto tráfico.
              </li>
              <li>
                <strong>Cerámica:</strong> A diferencia de las baldosas
                cerámicas, los pisos epóxicos no tienen juntas, lo que facilita
                la limpieza y evita la acumulación de suciedad en las grietas.
              </li>
              <li>
                <strong>Laminado:</strong> A diferencia de los pisos laminados,
                los epóxicos son más resistentes al desgaste y a los arañazos,
                lo que los hace más duraderos en el tiempo.
              </li>
              <li>
            ...
            <p className="text-gray-700 mt-2">
              ...
              importante considerar las necesidades y características
              específicas de tu proyecto antes de tomar una decisión.
            </p>
          </section>
          <section className="bg-white p-6 rounded shadow">
            <h2 className="text-xl font-semibold mb-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  pisos de resina epóxica puede demorar de 2 a 5 días,
                  incluyendo el tiempo de curado.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold mb-2">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  sencillo. Se recomienda limpiarlos regularmente con agua tibia
                  y un limpiador neutro. Evita el uso de productos químicos
