  ...
  return (
    <main className="container mx-auto py-8">
      <section className="bg-white p-6 rounded shadow">
        <h1 className="text-4xl font-semibold mb-4">Pisos de resina epóxica</h1>
        ...
        <p className="text-gray-700 mt-2">
          Además de su durabilidad, los pisos de resina epóxica también ofrecen
          una amplia gama de opciones de diseño. Pueden personalizarse con
          diferentes colores, patrones y efectos decorativos, lo que los
      ...
      <section className="bg-white p-6 rounded shadow">
        ...
        <p className="text-gray-700">
          Existen varios tipos de resinas epóxicas utilizadas en la creación de
          pisos duraderos y resistentes. Cada tipo tiene sus propias
          características y aplicaciones específicas. Algunos de los tipos más
          comunes son:
        </p>
        <ul className="list-disc list-inside text-gray-700 mt-2">
          <li>
            Resinas Epóxicas 100% Sólidas: Estas resinas no contienen solventes
            y ofrecen una alta resistencia química y mecánica. Son ideales para
            áreas de alto tráfico y exposición a productos químicos.
          </li>
          <li>
            Resinas Autonivelantes: Estas resinas se autonivelan durante su
            aplicación, creando una superficie uniforme. Son ideales para lograr
            un acabado liso y estético.
          </li>
          <li>
      ...
      <section className="bg-white p-6 rounded shadow">
        ...
        <ul className="list-disc list-inside text-gray-700 mt-2">
          <li>
            <strong>Durabilidadd:</strong> Los pisos de resina epóxica son
            altamente duraderos y resistentes al desgaste, lo que los hace
            ideales para áreas de alto tráfico.
          </li>
          <li>
            <strong>Resistencia Químicad:</strong> Son capaces de resistir
            productos químicos corrosivos, lo que los hace adecuados para
            entornos industriales y comerciales.
          </li>
          <li>
            <strong>Fácil Limpiezad:</strong> La superficie lisa y sin juntas
            facilita la limpieza y evita la acumulación de suciedad y gérmenes.
          </li>
          <li>
            <strong>Opciones de Diseñod:</strong> Se pueden personalizar con una
            amplia gama de colores, patrones y efectos decorativos.
          </li>
        </ul>
        <p className="text-gray-700 mt-2">
        ...
        <ul className="list-disc list-inside text-gray-700 mt-2">
          <li>
            <strong>Costo Iniciald:</strong> La instalación de pisos de resina
            epóxica puede ser más costosa en comparación con otros tipos de
            pavimentos.
          </li>
          <li>
            <strong>Sensibilidad a la Humedadd:</strong> Algunos tipos de
            resinas epóxicas pueden ser sensibles a la humedad, lo que podría
            afectar su durabilidad en ciertos entornos.
          </li>
          <li>
            <strong>Proceso de Instalaciónd:</strong> La instalación requiere un
            proceso específico que incluye preparación de la superficie, mezcla
            y aplicación de la resina, y tiempo de curado.
          </li>
        </ul>
      </section>
      ...
      <section className="bg-white p-6 rounded shadow">
        ...
        <ul className="list-disc list-inside text-gray-700 mt-2">
          <li>
            <strong>Áreas Industrialesd:</strong> Los pisos epóxicos son ideales
            para fábricas, almacenes y plantas de producción debido a su
            resistencia a productos químicos, impactos y tráfico pesado.
          </li>
          <li>
            <strong>Comercios y Tiendasd:</strong> En tiendas minoristas y
            comerciales, los pisos de resina epóxica proporcionan un aspecto
            atractivo y duradero para áreas de exhibición y ventas.
          </li>
          <li>
            <strong>Garajes y Talleresd:</strong> Son muy utilizados en garajes
            y talleres debido a su resistencia al aceite, grasa y abrasiones,
            además de ser fáciles de limpiar.
          </li>
          <li>
            <strong>Entornos Sanitariosd:</strong> En hospitales, laboratorios y
            espacios médicos, los pisos epóxicos ofrecen una superficie
            higiénica y fácil de desinfectar.
          </li>
          <li>
            <strong>Áreas de Alimentaciónd:</strong> En cocinas comerciales y
            restaurantes, los pisos de resina epóxica cumplen con los estándares
            de seguridad alimentaria y son resistentes a derrames.
          </li>
          <li>
            <strong>Instalaciones Deportivasd:</strong> En gimnasios y canchas
            deportivas, estos pisos proporcionan un acabado liso y amortiguado
            que es ideal para actividades físicas.
          </li>
        </ul>
        <p className="text-gray-700 mt-2">
          La capacidad de los pisos de resina epóxica para adaptarse a diversas
          condiciones y requerimientos hace que sean una opción popular en una
      ...
      <section className="bg-white p-6 rounded shadow">
        ...
        <ol className="list-decimal list-inside text-gray-700 mt-2">
          <li>
            <strong>Preparación de la Superficied:</strong> La superficie debe
            estar limpia, seca y libre de suciedad, grasa o contaminantes.
            Cualquier imperfección debe ser reparada y nivelada.
          </li>
          <li>
            <strong>Mezcla y Aplicación de la Resinad:</strong> La resina
            epóxica se mezcla siguiendo las instrucciones del fabricante. Luego,
            se aplica uniformemente sobre la superficie con rodillos o brochas.
          </li>
          <li>
            <strong>Autonivelación (si es necesario)d:</strong> En el caso de
            resinas autonivelantes, la resina se extenderá de manera uniforme
            para que se nivele por sí misma.
          </li>
          <li>
            <strong>Aplicación de Capas Decorativas (opcional)d:</strong> Se
            pueden agregar capas de colores, pigmentos o efectos decorativos
            durante la aplicación de la resina.
          </li>
          <li>
            <strong>Tiempo de Curadod:</strong> Después de aplicar la resina,
            debe dejarse curar durante el tiempo especificado por el fabricante.
            Durante este período, la resina se endurecerá y se volverá
            resistente.
          </li>
          <li>
            <strong>Sellado y Acabadod:</strong> Se puede aplicar una capa
        ...
        <p className="text-gray-700 mt-2">
          ...
          profesionales capacitados para asegurar que el proceso de instalación
      ...
      <section className="bg-white p-6 rounded shadow">
        ...
        <p className="text-gray-700">
          ...
          opciones permiten crear pisos únicos y personalizados que se adapten a
          la estética de cualquier espacio.
        </p>
        <p className="text-gray-700 mt-2">Algunas de las opciones incluyen:</p>
        <ul className="list-disc list-inside text-gray-700 mt-2">
          <li>
            <strong>Colores Sólidosd:</strong> Puedes elegir entre una variedad
            de colores sólidos para crear un fondo uniforme y moderno.
          </li>
          <li>
            <strong>Efectos Metálicosd:</strong> Los pisos epóxicos con efectos
            metálicos añaden un aspecto brillante y sofisticado, similar a los
            reflejos del metal.
          </li>
          <li>
            <strong>Marmoladosd:</strong> Mediante la combinación de colores y
            técnicas de marmolado, es posible lograr un acabado similar al
            mármol.
          </li>
          <li>
            <strong>Efectos Tridimensionalesd:</strong> Los pisos epóxicos
            pueden diseñarse para crear efectos en 3D que den profundidad y
            dinamismo al espacio.
          </li>
          <li>
            <strong>Logotipos y Diseños Personalizadosd:</strong> Se pueden
            incorporar logotipos, diseños geométricos y otros patrones
            personalizados en el piso.
          </li>
        </ul>
        <p className="text-gray-700 mt-2">
          La elección del diseño y los colores dependerá del estilo del entorno,
          su función y las preferencias estéticas del propietario. Consultar con
          profesionales puede ayudar a tomar decisiones informadas y creativas.
        </p>
      </section>
      <section className="bg-white p-6 rounded shadow">
        <h2 className="text-xl font-semibold mb-4">
        ...
        <p className="text-gray-700">
          ...
          facilidad de mantenimiento. Aquí hay algunos consejos para mantener y
          limpiar adecuadamente estos pisos:
        </p>
        <ul className="list-disc list-inside text-gray-700 mt-2">
          <li>
            <strong>Limpieza Regulard:</strong> Barre o aspira el piso
          ...
          <li>
            <strong>Derrames Rápidosd:</strong> Limpia los derrames de líquidos
            de inmediato para evitar que se absorban y causen manchas.
          </li>
          <li>
            <strong>Evita el Impactod:</strong> Aunque los pisos son
            resistentes, evita golpes o impactos fuertes que puedan dañar la
            superficie.
          </li>
          <li>
            <strong>Protégete al Mover Objetosd:</strong> Al mover muebles u
            objetos pesados, coloca almohadillas protectoras en las patas para
            evitar arañazos.
          </li>
          <li>
            <strong>Evita Sustancias Agresivasd:</strong> Evita el contacto con
            productos químicos agresivos que puedan dañar la resina.
          </li>
        </ul>
        <p className="text-gray-700 mt-2">
          Siguiendo estos consejos, los pisos de resina epóxica se mantendrán en
          excelentes condiciones y su aspecto perdurará a lo largo del tiempo.
        </p>
      </section>
      <section className="bg-white p-6 rounded shadow">
        <h2 className="text-xl font-semibold mb-4">
        ...
        <ul className="list-disc list-inside text-gray-700 mt-2">
          <li>
            <strong>Maderad:</strong> A diferencia de los pisos de madera, los
            epóxicos son más resistentes al agua y a los impactos, lo que los
            hace ideales para ambientes húmedos o de alto tráfico.
          </li>
          <li>
            <strong>Cerámicad:</strong> A diferencia de las baldosas cerámicas,
            los pisos epóxicos no tienen juntas, lo que facilita la limpieza y
            evita la acumulación de suciedad en las grietas.
          </li>
          <li>
            <strong>Laminadod:</strong> A diferencia de los pisos laminados, los
            epóxicos son más resistentes al desgaste y a los arañazos, lo que
            los hace más duraderos en el tiempo.
          </li>
          <li>
            <strong>Alfombrasd:</strong> A diferencia de las alfombras, los
        ...
        <p className="text-gray-700 mt-2">
          ...
          importante considerar las necesidades y características específicas de
          tu proyecto antes de tomar una decisión.
        </p>
      </section>
      <section className="bg-white p-6 rounded shadow">
        <h2 className="text-xl font-semibold mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 bg-gray-200 rounded">
            ...
            <p className="text-gray-700">
              En un hotel de lujo, se eligieron pisos de resina epóxica para las
              áreas comunes debido a su elegante apariencia y fácil
              mantenimiento. Los huéspedes quedaron impresionados con la calidad
              y durabilidad de los pisos.
            </p>
          </div>
          <div className="p-4 bg-gray-200 rounded">
            <h3 className="text-lg font-semibold mb-2">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-700">
              ...
              pisos de resina epóxica puede demorar de 2 a 5 días, incluyendo el
              tiempo de curado.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-700">
              ...
              grietas pueden repararse mediante un proceso de pulido y relleno.
              En casos más graves, es posible que se requiera un trabajo más
              extenso de reparación.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-2">
            ...
            <p className="text-gray-700">
              ...
              un limpiador neutro. Evita el uso de productos químicos agresivos
              o abrasivos que puedan dañar la resina.
            </p>
          </div>
        </div>
      </section>
