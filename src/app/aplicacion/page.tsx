      ...
      <main className="mx-4 md:mx-auto  md:w-3/4">
        <section className="bg-white p-6 rounded shadow">
          ...
          <p className="text-gray-700">
            Aplicar pisos de resina epóxica requiere atención meticulosa y
            cierto nivel de habilidad. Aquí tienes una guía básica paso a paso
            para aplicar resina epóxica en un suelo:
          </p>

          <h2 className="text-xl font-semibold mb-4 mt-4">Pasos:</h2>
          <ol className="list-decimal list-inside">
            <li>
              <strong>Preparación del área:</strong> Limpia y despeja el área a
              tratar. Asegúrate de que la superficie esté completamente seca,
              sin polvo ni grasa. Si hay grietas o irregularidades, repara y
              nivela la superficie. Si es necesario, lija para suavizar y
              nivelar.
            </li>
            <li>
        ...
        <section className="bg-white p-6 rounded shadow">
          <p className="text-gray-700 mt-4">
            Para la colocación de estos pisos te recomendamos usar estos
            materiales.
          </p>
